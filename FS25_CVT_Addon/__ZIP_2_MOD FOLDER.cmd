...
echo.
echo ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ 
C:\Programme\7-Zip\7z.exe a "%~dp0"%name_parent% -w "%~dp0"* -xr!*.cmd -xr!*.bak -xr!*.akt -xr!*.7z -xr!*.zip -xr!*.png -xr!*.gsp -xr!*.gspu -xr!*.jpg -xr!Old -xr!VCA_modified -xr!log -xr!*.psd -xr!screenshots -xr!_ZiP_log.txt -xr!offline -tzip
echo ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ 
echo.
echo.
echo.
...
move /Y "%~dp0"%name_parent%.zip "C:\Users\SbSh\Documents\My Games\FarmingSimulator2025\mods"
echo                                   nach "C:\Users\SbSh\Documents\My Games\FarmingSimulator2025\mods\%name_parent%.zip" 
REM timeout /T 2
REM pause
goto end
